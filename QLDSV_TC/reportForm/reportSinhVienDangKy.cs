...
namespace QLDSV_TC
{
    public partial class reportSinhVienDangKy : Form
    {
        public reportSinhVienDangKy()
        {
            InitializeComponent();
        }
        ...
        private void reportSinhVienDangKy_Load(object sender, EventArgs e)
        {
        ...
        private void btnExport_Click(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            rptDanhSachSinhVienDangKy rpt = new rptDanhSachSinhVienDangKy(nienkhoa, hocky, nhom, monhoc);
